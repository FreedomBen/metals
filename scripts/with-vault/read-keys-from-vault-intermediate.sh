...
get_path_key "mtls/script/intermediate-ca" "key"
get_path_key "mtls/script/intermediate-ca" "crt"

get_path_key "mtls/script/trust-chain" "client"
get_path_key "mtls/script/trust-chain" "server"
